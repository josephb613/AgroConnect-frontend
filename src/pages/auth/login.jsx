...
//                     <div className="">
//                         <img src="https://res.cloudinary.com/dqrs3xyic/image/upload/v1714220257/Projet%20Agroconnect/Default_Imagine_a_scene_where_an_African_female_farmer_works_i_2_nyk16v.jpg" width={150} className="lg:hidden" />
...
import { FaSeedling } from 'react-icons/fa'; // Importer l'icône Seedling de FontAwesome
    ...
    <div className="min-h-screen bg-green-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex items-center justify-center">
          <FaSeedling className="h-10 w-10 text-green-600" />
          <h2 className="ml-2 text-3xl font-extrabold text-green-600"></h2>
        </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
                Connexion
              </button>
            </div>
