    ...
    <ul className="text-gray-500 dark:text-gray-400">
      {links.map((link, index) => (
        <li key={index} className="mb-4">
          <NavLink to={link.url} className="hover:underline">
            {link.text}
          </NavLink>
        </li>
      ))}
...
export default function Footer() {
  ...
  return (
    <footer className="bg-bg-green border  font-thin">
      <img src="https://res.cloudinary.com/dqrs3xyic/image/upload/v1712325531/papers_yhwywj.png" alt="" className="  mb-10 md:-mt-10 md:w-full  sm:mt-5" />
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 text-white md:mb-0">
           <img src="https://res.cloudinary.com/dqrs3xyic/image/upload/v1712706483/icons/Group_34_pa0tqi.png" alt="logo footer" />
          </div>
          <div className="grid   text-white md:grid-cols-4 md:gap-6 xs:grid-cols-2 xs:bg-red">
        ...
        <div className="md:w-[23%] md:ml-[45%] sm:flex sm:items-center sm:ml-[40%] sm:justify-between">
...
//   return (
//       <footer className=" w-full  px-4 py-5 max-w-screen-xl mx-auto md:px-8">
